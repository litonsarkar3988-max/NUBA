# Mini App: Date Diff Calc
# Category: Calculators

print("=== Date Diff Calc ===")

class DatediffcalcApp {
    fun init(self) {
        self.name    = "Date Diff Calc"
        self.version = "1.0.0"
        self.history = []
