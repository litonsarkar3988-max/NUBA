# Mini App: Time Zone Calc
# Category: Calculators

print("=== Time Zone Calc ===")

class TimezonecalcApp {
    fun init(self) {
        self.name    = "Time Zone Calc"
        self.version = "1.0.0"
        self.history = []
