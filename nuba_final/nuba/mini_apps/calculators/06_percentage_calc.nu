# Mini App: Percentage Calc
# Category: Calculators

print("=== Percentage Calc ===")

class PercentagecalcApp {
    fun init(self) {
        self.name    = "Percentage Calc"
        self.version = "1.0.0"
        self.history = []
