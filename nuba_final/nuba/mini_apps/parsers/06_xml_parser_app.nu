# Mini App: Xml Parser App
# Category: Parsers

print("=== Xml Parser App ===")

class XmlparserappApp {
    fun init(self) {
        self.name    = "Xml Parser App"
        self.version = "1.0.0"
        self.history = []
