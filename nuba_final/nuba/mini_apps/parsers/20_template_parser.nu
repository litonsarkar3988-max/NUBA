# Mini App: Template Parser
# Category: Parsers

print("=== Template Parser ===")

class TemplateparserApp {
    fun init(self) {
        self.name    = "Template Parser"
        self.version = "1.0.0"
        self.history = []
