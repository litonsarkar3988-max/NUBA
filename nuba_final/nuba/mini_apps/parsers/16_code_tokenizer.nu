# Mini App: Code Tokenizer
# Category: Parsers

print("=== Code Tokenizer ===")

class CodetokenizerApp {
    fun init(self) {
        self.name    = "Code Tokenizer"
        self.version = "1.0.0"
        self.history = []
