# Mini App: Math Expr Parser
# Category: Parsers

print("=== Math Expr Parser ===")

class MathexprparserApp {
    fun init(self) {
        self.name    = "Math Expr Parser"
        self.version = "1.0.0"
        self.history = []
    ...
    fun run(self, input_data) {
        print("Running Math Expr Parser...")
