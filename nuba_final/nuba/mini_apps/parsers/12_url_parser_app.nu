# Mini App: Url Parser App
# Category: Parsers

print("=== Url Parser App ===")

class UrlparserappApp {
    fun init(self) {
        self.name    = "Url Parser App"
        self.version = "1.0.0"
        self.history = []
