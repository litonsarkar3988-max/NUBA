# Mini App: Yaml Parser App
# Category: Parsers

print("=== Yaml Parser App ===")

class YamlparserappApp {
    fun init(self) {
        self.name    = "Yaml Parser App"
        self.version = "1.0.0"
        self.history = []
