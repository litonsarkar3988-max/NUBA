# Mini App: Config Parser App
# Category: Parsers

print("=== Config Parser App ===")

class ConfigparserappApp {
    fun init(self) {
        self.name    = "Config Parser App"
        self.version = "1.0.0"
        self.history = []
    ...
    fun run(self, input_data) {
        print("Running Config Parser App...")
...
let app = new ConfigparserappApp()
