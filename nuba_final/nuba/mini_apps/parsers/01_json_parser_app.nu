# Mini App: Json Parser App
# Category: Parsers

print("=== Json Parser App ===")

class JsonparserappApp {
    fun init(self) {
        self.name    = "Json Parser App"
        self.version = "1.0.0"
        self.history = []
