# Mini App: Cli Args Parser
# Category: Parsers

print("=== Cli Args Parser ===")

class CliargsparserApp {
    fun init(self) {
        self.name    = "Cli Args Parser"
        self.version = "1.0.0"
        self.history = []
