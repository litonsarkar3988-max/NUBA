# Mini App: Isbn Validator
# Category: Validators

print("=== Isbn Validator ===")

class IsbnvalidatorApp {
    fun init(self) {
        self.name    = "Isbn Validator"
        self.version = "1.0.0"
        self.history = []
