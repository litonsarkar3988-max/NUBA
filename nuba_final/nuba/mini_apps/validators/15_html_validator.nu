# Mini App: Html Validator
# Category: Validators

print("=== Html Validator ===")

class HtmlvalidatorApp {
    fun init(self) {
        self.name    = "Html Validator"
        self.version = "1.0.0"
        self.history = []
