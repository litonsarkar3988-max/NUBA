# Mini App: Yaml Validator
# Category: Validators

print("=== Yaml Validator ===")

class YamlvalidatorApp {
    fun init(self) {
        self.name    = "Yaml Validator"
        self.version = "1.0.0"
        self.history = []
