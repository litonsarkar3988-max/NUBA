# Mini App: Title Case Tool
# Category: Text Processors

print("=== Title Case Tool ===")

class TitlecasetoolApp {
    fun init(self) {
        self.name    = "Title Case Tool"
        self.version = "1.0.0"
        self.history = []
