# Mini App: Pathfinding Sim
# Category: Simulators

print("=== Pathfinding Sim ===")

class PathfindingsimApp {
    fun init(self) {
        self.name    = "Pathfinding Sim"
        self.version = "1.0.0"
        self.history = []
