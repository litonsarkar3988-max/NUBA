# Mini App: Coffee Shop Sim
# Category: Simulators

print("=== Coffee Shop Sim ===")

class CoffeeshopsimApp {
    fun init(self) {
        self.name    = "Coffee Shop Sim"
        self.version = "1.0.0"
        self.history = []
