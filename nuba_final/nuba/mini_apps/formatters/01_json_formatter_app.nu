# Mini App: Json Formatter App
# Category: Formatters

print("=== Json Formatter App ===")

class JsonformatterappApp {
    fun init(self) {
        self.name    = "Json Formatter App"
        self.version = "1.0.0"
        self.history = []
    ...
    fun run(self, input_data) {
        print("Running Json Formatter App...")
...
let app = new JsonformatterappApp()
