# Mini App: Phone Formatter
# Category: Formatters

print("=== Phone Formatter ===")

class PhoneformatterApp {
    fun init(self) {
        self.name    = "Phone Formatter"
        self.version = "1.0.0"
        self.history = []
