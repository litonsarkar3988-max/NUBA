# Mini App: Random Data Gen
# Category: Cli Tools

print("=== Random Data Gen ===")

class RandomdatagenApp {
    fun init(self) {
        self.name    = "Random Data Gen"
        self.version = "1.0.0"
        self.history = []
