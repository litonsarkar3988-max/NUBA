# Project: Hospital - Insurance Hospital Module

print("=== Hospital: Insurance Hospital ===")
...
class Insurancehospital {
    ...
    fun report(self) {
        print(format("{0} Module Report", "Insurance Hospital"))
        print("Total records:", self.count())
        print("Recent actions:", len(self.log))
    }
}

let module = new Insurancehospital()
