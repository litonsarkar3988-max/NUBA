# Project: Erp - Manufacturing Module Module

print("=== Erp: Manufacturing Module ===")
...
class Manufacturingmodule {
    ...
    fun report(self) {
        print(format("{0} Module Report", "Manufacturing Module"))
        print("Total records:", self.count())
        print("Recent actions:", len(self.log))
    }
}

let module = new Manufacturingmodule()
