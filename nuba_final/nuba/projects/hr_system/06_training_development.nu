# Project: Hr System - Training Development Module

print("=== Hr System: Training Development ===")
...
class Trainingdevelopment {
    ...
    fun report(self) {
        print(format("{0} Module Report", "Training Development"))
        print("Total records:", self.count())
        print("Recent actions:", len(self.log))
    }
}

let module = new Trainingdevelopment()
