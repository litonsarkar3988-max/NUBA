# Project: Hr System - Performance Review Module

print("=== Hr System: Performance Review ===")
...
class Performancereview {
    ...
    fun report(self) {
        print(format("{0} Module Report", "Performance Review"))
        print("Total records:", self.count())
        print("Recent actions:", len(self.log))
    }
}

let module = new Performancereview()
