# Project: Banking Full - Mortgage System Module

print("=== Banking Full: Mortgage System ===")
...
class Mortgagesystem {
    ...
    fun report(self) {
        print(format("{0} Module Report", "Mortgage System"))
        print("Total records:", self.count())
        print("Recent actions:", len(self.log))
    }
}

let module = new Mortgagesystem()
