# Project: Banking Full - Transaction System Module

print("=== Banking Full: Transaction System ===")
...
class Transactionsystem {
    ...
    fun report(self) {
        print(format("{0} Module Report", "Transaction System"))
        print("Total records:", self.count())
        print("Recent actions:", len(self.log))
    }
}

let module = new Transactionsystem()
