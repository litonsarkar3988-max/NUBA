# Project: Banking Full - Account Management Module

print("=== Banking Full: Account Management ===")
...
class Accountmanagement {
    ...
    fun report(self) {
        print(format("{0} Module Report", "Account Management"))
        print("Total records:", self.count())
        print("Recent actions:", len(self.log))
    }
}

let module = new Accountmanagement()
