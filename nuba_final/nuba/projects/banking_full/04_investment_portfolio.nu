# Project: Banking Full - Investment Portfolio Module

print("=== Banking Full: Investment Portfolio ===")
...
class Investmentportfolio {
    ...
    fun report(self) {
        print(format("{0} Module Report", "Investment Portfolio"))
        print("Total records:", self.count())
        print("Recent actions:", len(self.log))
    }
}

let module = new Investmentportfolio()
