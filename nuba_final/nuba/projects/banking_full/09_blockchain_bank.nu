# Project: Banking Full - Blockchain Bank Module

print("=== Banking Full: Blockchain Bank ===")
...
class Blockchainbank {
    ...
    fun report(self) {
        print(format("{0} Module Report", "Blockchain Bank"))
        print("Total records:", self.count())
        print("Recent actions:", len(self.log))
    }
}

let module = new Blockchainbank()
