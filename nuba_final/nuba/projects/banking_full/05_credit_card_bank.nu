# Project: Banking Full - Credit Card Bank Module

print("=== Banking Full: Credit Card Bank ===")
...
class Creditcardbank {
    ...
    fun report(self) {
        print(format("{0} Module Report", "Credit Card Bank"))
        print("Total records:", self.count())
        print("Recent actions:", len(self.log))
    }
}

let module = new Creditcardbank()
