# Project: Social Media - Moderation System Module

print("=== Social Media: Moderation System ===")
...
class Moderationsystem {
    ...
    fun report(self) {
        print(format("{0} Module Report", "Moderation System"))
        print("Total records:", self.count())
        print("Recent actions:", len(self.log))
    }
}

let module = new Moderationsystem()
