# Project: Real Estate - Rental Management Module

print("=== Real Estate: Rental Management ===")
...
class Rentalmanagement {
    ...
    fun report(self) {
        print(format("{0} Module Report", "Rental Management"))
        print("Total records:", self.count())
        print("Recent actions:", len(self.log))
    }
}

let module = new Rentalmanagement()
