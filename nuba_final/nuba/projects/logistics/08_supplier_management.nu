# Project: Logistics - Supplier Management Module

print("=== Logistics: Supplier Management ===")
...
class Suppliermanagement {
    ...
    fun report(self) {
        print(format("{0} Module Report", "Supplier Management"))
        print("Total records:", self.count())
        print("Recent actions:", len(self.log))
    }
}

let module = new Suppliermanagement()
