# Concept Tutorial 12: Union-Find/DSU

# This tutorial explains: Union-Find/DSU
...
fun example_1() {
    print("Example 1: Basic Union-Find/DSU")
...
fun example_2() {
    print("\nExample 2: Applied Union-Find/DSU")
    let n = 10
    let result = []
...
fun example_3() {
    print("\nExample 3: Real-world Union-Find/DSU")
