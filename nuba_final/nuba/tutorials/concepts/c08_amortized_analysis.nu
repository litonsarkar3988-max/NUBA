# Concept Tutorial 8: Amortized Analysis

# This tutorial explains: Amortized Analysis
...
fun example_1() {
    print("Example 1: Basic Amortized Analysis")
...
fun example_2() {
    print("\nExample 2: Applied Amortized Analysis")
    let n = 10
    let result = []
...
fun example_3() {
    print("\nExample 3: Real-world Amortized Analysis")
