# Concept Tutorial 11: Monotonic Stack

# This tutorial explains: Monotonic Stack
...
fun example_1() {
    print("Example 1: Basic Monotonic Stack")
...
fun example_2() {
    print("\nExample 2: Applied Monotonic Stack")
    let n = 10
    let result = []
...
fun example_3() {
    print("\nExample 3: Real-world Monotonic Stack")
