# Concept Tutorial 15: Prefix and Suffix Arrays

# This tutorial explains: Prefix and Suffix Arrays
# With practical Nuba examples

print("=== Prefix and Suffix Arrays ===")
print()

# Example 1: Basic demonstration
fun example_1() {
    print("Example 1: Basic Prefix and Suffix Arrays")
...
fun example_2() {
    print("\nExample 2: Applied Prefix and Suffix Arrays")
    let n = 10
    let result = []
...
fun example_3() {
    print("\nExample 3: Real-world Prefix and Suffix Arrays")
