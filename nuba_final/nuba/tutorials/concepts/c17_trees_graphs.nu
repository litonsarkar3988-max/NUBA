# Concept Tutorial 17: Trees vs Graphs

# This tutorial explains: Trees vs Graphs
# With practical Nuba examples

print("=== Trees vs Graphs ===")
print()

# Example 1: Basic demonstration
fun example_1() {
    print("Example 1: Basic Trees vs Graphs")
...
fun example_2() {
    print("\nExample 2: Applied Trees vs Graphs")
    let n = 10
    let result = []
...
fun example_3() {
    print("\nExample 3: Real-world Trees vs Graphs")
