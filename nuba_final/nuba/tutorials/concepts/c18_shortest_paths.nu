# Concept Tutorial 18: Shortest Path Algorithms

# This tutorial explains: Shortest Path Algorithms
...
fun example_1() {
    print("Example 1: Basic Shortest Path Algorithms")
...
fun example_2() {
    print("\nExample 2: Applied Shortest Path Algorithms")
    let n = 10
    let result = []
...
fun example_3() {
    print("\nExample 3: Real-world Shortest Path Algorithms")
