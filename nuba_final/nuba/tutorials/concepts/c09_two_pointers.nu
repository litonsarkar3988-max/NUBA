# Concept Tutorial 9: Two Pointers Technique

# This tutorial explains: Two Pointers Technique
...
fun example_1() {
    print("Example 1: Basic Two Pointers Technique")
...
fun example_2() {
    print("\nExample 2: Applied Two Pointers Technique")
    let n = 10
    let result = []
...
fun example_3() {
    print("\nExample 3: Real-world Two Pointers Technique")
