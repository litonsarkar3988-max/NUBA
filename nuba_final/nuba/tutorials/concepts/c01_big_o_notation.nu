# Concept Tutorial 1: Big O Notation Examples in Nuba

# This tutorial explains: Big O Notation Examples in Nuba
# With practical Nuba examples

print("=== Big O Notation Examples in Nuba ===")
print()

# Example 1: Basic demonstration
fun example_1() {
    print("Example 1: Basic Big O Notation Examples in Nuba")
...
fun example_2() {
    print("\nExample 2: Applied Big O Notation Examples in Nuba")
    let n = 10
    let result = []
...
fun example_3() {
    print("\nExample 3: Real-world Big O Notation Examples in Nuba")
