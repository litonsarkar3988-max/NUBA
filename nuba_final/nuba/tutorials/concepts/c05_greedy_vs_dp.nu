# Concept Tutorial 5: Greedy vs Dynamic Programming

# This tutorial explains: Greedy vs Dynamic Programming
...
fun example_1() {
    print("Example 1: Basic Greedy vs Dynamic Programming")
...
fun example_2() {
    print("\nExample 2: Applied Greedy vs Dynamic Programming")
    let n = 10
    let result = []
...
fun example_3() {
    print("\nExample 3: Real-world Greedy vs Dynamic Programming")
