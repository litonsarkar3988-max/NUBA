// Algorithm (C++): Tree Traversals and Operations
#include <iostream>
#include <vector>
#include <algorithm>
#include <numeric>
...
// Tree Traversals and Operations Implementation

class Solution {
public:
    // Main algorithm: Tree Traversals and Operations
    template<typename T>
...
int main() {
    cout << "=== Tree Traversals and Operations ===" << endl;
