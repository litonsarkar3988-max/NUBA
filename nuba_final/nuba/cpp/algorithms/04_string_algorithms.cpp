// Algorithm (C++): String Matching (KMP, Rabin-Karp)
#include <iostream>
#include <vector>
#include <algorithm>
#include <numeric>
...
// String Matching (KMP, Rabin-Karp) Implementation

class Solution {
public:
    // Main algorithm: String Matching (KMP, Rabin-Karp)
    template<typename T>
...
int main() {
    cout << "=== String Matching (KMP, Rabin-Karp) ===" << endl;
