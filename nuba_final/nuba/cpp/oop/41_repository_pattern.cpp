...
public:
    ...
    string describe() const override {
        return "Repository Pattern [" + name + "] value=" + to_string(value);
    }
};
...
int main() {
    Manager mgr;
    for (int i = 1; i <= 5; i++) {
        mgr.add(make_shared<Concrete>("Repository Pattern_" + to_string(i), i * 10));
    }
    cout << "=== Repository Pattern Demo ===" << endl;
