// C++ OOP Pattern 48: Event Sourcing Oop
...
// Event Sourcing Oop Pattern Implementation
...
public:
    ...
    string type() const override { return "Derived(event_sourcing_oop)"; }
};

int main() {
    // Demonstrate event sourcing oop
