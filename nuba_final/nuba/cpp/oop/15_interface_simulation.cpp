// C++ OOP Pattern 15: Interface Simulation
...
// Interface Simulation Pattern Implementation
...
public:
    ...
    string type() const override { return "Derived(interface_simulation)"; }
};

int main() {
    // Demonstrate interface simulation
