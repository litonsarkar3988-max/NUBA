// C++ OOP Pattern 18: Policy Based Design
...
// Policy Based Design Pattern Implementation
...
public:
    ...
    string type() const override { return "Derived(policy_based_design)"; }
};

int main() {
    // Demonstrate policy based design
