...
public:
    ...
    string describe() const override {
        return "Publish-Subscribe [" + name + "] value=" + to_string(value);
    }
};
...
int main() {
    Manager mgr;
    for (int i = 1; i <= 5; i++) {
        mgr.add(make_shared<Concrete>("Publish-Subscribe_" + to_string(i), i * 10));
    }
    cout << "=== Publish-Subscribe Demo ===" << endl;
