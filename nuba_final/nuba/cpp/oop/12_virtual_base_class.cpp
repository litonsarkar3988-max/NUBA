// C++ OOP Pattern 12: Virtual Base Class
...
// Virtual Base Class Pattern Implementation
...
public:
    ...
    string type() const override { return "Derived(virtual_base_class)"; }
};

int main() {
    // Demonstrate virtual base class
