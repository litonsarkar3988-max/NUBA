...
public:
    ...
    string describe() const override {
        return "Null Object Pattern [" + name + "] value=" + to_string(value);
    }
};
...
int main() {
    Manager mgr;
    for (int i = 1; i <= 5; i++) {
        mgr.add(make_shared<Concrete>("Null Object Pattern_" + to_string(i), i * 10));
    }
    cout << "=== Null Object Pattern Demo ===" << endl;
