...
public:
    ...
    string describe() const override {
        return "Chain of Responsibility [" + name + "] value=" + to_string(value);
    }
};
...
int main() {
    Manager mgr;
    for (int i = 1; i <= 5; i++) {
        mgr.add(make_shared<Concrete>("Chain of Responsibility_" + to_string(i), i * 10));
    }
    cout << "=== Chain of Responsibility Demo ===" << endl;
