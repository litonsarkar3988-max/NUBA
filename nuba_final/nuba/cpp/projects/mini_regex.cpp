...
// Complete Mini Regex implementation
...
public:
    explicit Miniregex(size_t cap = 16)
        : capacity(cap) {
        data.reserve(cap);
    }
...
int main() {
    cout << "=== Mini Regex ===" << endl;

    Miniregex<int> container(20);
