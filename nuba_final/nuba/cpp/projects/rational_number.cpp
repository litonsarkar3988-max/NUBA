...
// Complete Rational Number implementation
...
public:
    explicit Rationalnumber(size_t cap = 16)
        : capacity(cap) {
        data.reserve(cap);
    }
    ...
    template<typename F>
    Rationalnumber filter(F pred) const {
...
int main() {
    ...
    Rationalnumber<int> container(20);
