...
// Complete Graph Complete implementation
...
public:
    explicit Graphcomplete(size_t cap = 16)
        : capacity(cap) {
        data.reserve(cap);
    }
    ...
    template<typename F>
    Graphcomplete filter(F pred) const {
        Graphcomplete result;
...
int main() {
    ...
    Graphcomplete<int> container(20);
