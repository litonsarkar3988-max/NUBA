# Data Science - Model Evaluation: Pr Auc
...
# Pr Auc specific implementation
fun pr_auc(data, params) {
    print("Running: Pr Auc")
...
let result = pr_auc(dataset, {"alpha":0.05,"iterations":100})
