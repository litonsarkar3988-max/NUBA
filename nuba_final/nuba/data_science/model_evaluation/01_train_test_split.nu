# Data Science - Model Evaluation: Train Test Split
...
# Train Test Split specific implementation
fun train_test_split(data, params) {
...
let result = train_test_split(dataset, {"alpha":0.05,"iterations":100})
