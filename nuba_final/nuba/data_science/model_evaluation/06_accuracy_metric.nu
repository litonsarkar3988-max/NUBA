# Data Science - Model Evaluation: Accuracy Metric
...
# Accuracy Metric specific implementation
fun accuracy_metric(data, params) {
    print("Running: Accuracy Metric")
...
let result = accuracy_metric(dataset, {"alpha":0.05,"iterations":100})
