# Data Science - Model Evaluation: R Squared
...
# R Squared specific implementation
fun r_squared(data, params) {
    print("Running: R Squared")
...
let result = r_squared(dataset, {"alpha":0.05,"iterations":100})
