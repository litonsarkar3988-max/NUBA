# Data Science - Model Evaluation: Mse Mae
...
# Mse Mae specific implementation
fun mse_mae(data, params) {
    print("Running: Mse Mae")
...
let result = mse_mae(dataset, {"alpha":0.05,"iterations":100})
