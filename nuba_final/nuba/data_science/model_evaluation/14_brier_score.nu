# Data Science - Model Evaluation: Brier Score
...
# Brier Score specific implementation
fun brier_score(data, params) {
    print("Running: Brier Score")
...
let result = brier_score(dataset, {"alpha":0.05,"iterations":100})
