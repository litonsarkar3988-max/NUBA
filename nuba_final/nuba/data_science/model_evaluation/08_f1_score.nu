# Data Science - Model Evaluation: F1 Score
...
# F1 Score specific implementation
fun f1_score(data, params) {
    print("Running: F1 Score")
...
let result = f1_score(dataset, {"alpha":0.05,"iterations":100})
