# Data Science - Model Evaluation: Confusion Matrix
...
# Confusion Matrix specific implementation
fun confusion_matrix(data, params) {
...
let result = confusion_matrix(dataset, {"alpha":0.05,"iterations":100})
