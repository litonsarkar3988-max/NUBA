# Data Science - Model Evaluation: Silhouette Score
...
# Silhouette Score specific implementation
fun silhouette_score(data, params) {
...
let result = silhouette_score(dataset, {"alpha":0.05,"iterations":100})
