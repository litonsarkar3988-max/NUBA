# Data Science - Model Evaluation: Precision Recall
...
# Precision Recall specific implementation
fun precision_recall(data, params) {
...
let result = precision_recall(dataset, {"alpha":0.05,"iterations":100})
