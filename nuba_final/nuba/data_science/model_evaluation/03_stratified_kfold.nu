# Data Science - Model Evaluation: Stratified Kfold
...
# Stratified Kfold specific implementation
fun stratified_kfold(data, params) {
    print("Running: Stratified Kfold")
...
let result = stratified_kfold(dataset, {"alpha":0.05,"iterations":100})
