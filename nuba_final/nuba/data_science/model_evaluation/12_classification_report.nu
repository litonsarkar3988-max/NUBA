# Data Science - Model Evaluation: Classification Report
...
# Classification Report specific implementation
fun classification_report(data, params) {
...
let result = classification_report(dataset, {"alpha":0.05,"iterations":100})
