# Data Science - Model Evaluation: Leave One Out
...
# Leave One Out specific implementation
fun leave_one_out(data, params) {
...
let result = leave_one_out(dataset, {"alpha":0.05,"iterations":100})
