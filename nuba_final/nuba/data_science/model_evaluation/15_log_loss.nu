# Data Science - Model Evaluation: Log Loss
...
# Log Loss specific implementation
fun log_loss(data, params) {
    print("Running: Log Loss")
...
let result = log_loss(dataset, {"alpha":0.05,"iterations":100})
