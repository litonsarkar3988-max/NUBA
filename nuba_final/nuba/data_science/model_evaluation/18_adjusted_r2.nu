# Data Science - Model Evaluation: Adjusted R2
...
# Adjusted R2 specific implementation
fun adjusted_r2(data, params) {
    print("Running: Adjusted R2")
...
let result = adjusted_r2(dataset, {"alpha":0.05,"iterations":100})
