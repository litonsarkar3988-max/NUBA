# Data Science - Model Evaluation: K Fold Cv
...
# K Fold Cv specific implementation
fun k_fold_cv(data, params) {
...
let result = k_fold_cv(dataset, {"alpha":0.05,"iterations":100})
