# Data Science - Model Evaluation: Time Series Cv
...
# Time Series Cv specific implementation
fun time_series_cv(data, params) {
...
let result = time_series_cv(dataset, {"alpha":0.05,"iterations":100})
