# Data Science - Model Evaluation: Aic Bic
...
# Aic Bic specific implementation
fun aic_bic(data, params) {
    print("Running: Aic Bic")
...
let result = aic_bic(dataset, {"alpha":0.05,"iterations":100})
