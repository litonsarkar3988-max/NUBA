# Data Science - Feature Engineering: Entity Embeddings
...
# Entity Embeddings specific implementation
fun entity_embeddings(data, params) {
    print("Running: Entity Embeddings")
...
let result = entity_embeddings(dataset, {"alpha":0.05,"iterations":100})
