# Data Science - Feature Engineering: Image Features
...
# Image Features specific implementation
fun image_features(data, params) {
    print("Running: Image Features")
...
let result = image_features(dataset, {"alpha":0.05,"iterations":100})
