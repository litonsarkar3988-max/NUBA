# Data Science - Feature Engineering: Sentence Embeddings
...
# Sentence Embeddings specific implementation
fun sentence_embeddings(data, params) {
...
let result = sentence_embeddings(dataset, {"alpha":0.05,"iterations":100})
