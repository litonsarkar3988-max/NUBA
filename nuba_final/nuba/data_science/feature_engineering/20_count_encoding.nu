# Data Science - Feature Engineering: Count Encoding
...
# Count Encoding specific implementation
fun count_encoding(data, params) {
    print("Running: Count Encoding")
...
let result = count_encoding(dataset, {"alpha":0.05,"iterations":100})
