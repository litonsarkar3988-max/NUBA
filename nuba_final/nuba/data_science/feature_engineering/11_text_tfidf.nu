# Data Science - Feature Engineering: Text Tfidf
...
# Text Tfidf specific implementation
fun text_tfidf(data, params) {
    print("Running: Text Tfidf")
...
let result = text_tfidf(dataset, {"alpha":0.05,"iterations":100})
