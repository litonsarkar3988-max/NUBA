# Data Science - Feature Engineering: Ewm Features
...
# Ewm Features specific implementation
fun ewm_features(data, params) {
    print("Running: Ewm Features")
...
let result = ewm_features(dataset, {"alpha":0.05,"iterations":100})
