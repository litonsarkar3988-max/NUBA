# Data Science - Feature Engineering: Binning Features
...
# Binning Features specific implementation
fun binning_features(data, params) {
    print("Running: Binning Features")
...
let result = binning_features(dataset, {"alpha":0.05,"iterations":100})
