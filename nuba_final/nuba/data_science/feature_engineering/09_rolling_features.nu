# Data Science - Feature Engineering: Rolling Features
...
# Rolling Features specific implementation
fun rolling_features(data, params) {
    print("Running: Rolling Features")
...
let result = rolling_features(dataset, {"alpha":0.05,"iterations":100})
