# Data Science - Feature Engineering: Box Cox
...
# Box Cox specific implementation
fun box_cox(data, params) {
    print("Running: Box Cox")
...
let result = box_cox(dataset, {"alpha":0.05,"iterations":100})
