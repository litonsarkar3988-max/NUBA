# Data Science - Feature Engineering: Log Transform
...
# Log Transform specific implementation
fun log_transform(data, params) {
...
let result = log_transform(dataset, {"alpha":0.05,"iterations":100})
