# Data Science - Feature Engineering: Word Embeddings
...
# Word Embeddings specific implementation
fun word_embeddings(data, params) {
    print("Running: Word Embeddings")
...
let result = word_embeddings(dataset, {"alpha":0.05,"iterations":100})
