# Data Science - Feature Engineering: Interaction Features
...
# Interaction Features specific implementation
fun interaction_features(data, params) {
    print("Running: Interaction Features")
...
let result = interaction_features(dataset, {"alpha":0.05,"iterations":100})
