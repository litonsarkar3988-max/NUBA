# Data Science - Feature Engineering: Frequency Encoding
...
# Frequency Encoding specific implementation
fun frequency_encoding(data, params) {
    print("Running: Frequency Encoding")
...
let result = frequency_encoding(dataset, {"alpha":0.05,"iterations":100})
