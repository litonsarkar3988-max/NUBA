# Data Science - Feature Engineering: Ratio Features
...
# Ratio Features specific implementation
fun ratio_features(data, params) {
    print("Running: Ratio Features")
...
let result = ratio_features(dataset, {"alpha":0.05,"iterations":100})
