...
# Tf Idf Nlp specific implementation
fun tf_idf_nlp(data, params) {
    print("Running: Tf Idf Nlp")
...
let result = tf_idf_nlp(dataset, {"alpha":0.05,"iterations":100})
