# Data Science - Nlp: Text Summarization
...
# Text Summarization specific implementation
fun text_summarization(data, params) {
...
let result = text_summarization(dataset, {"alpha":0.05,"iterations":100})
