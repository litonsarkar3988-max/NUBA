# Data Science - Nlp: Question Answering
...
# Question Answering specific implementation
fun question_answering(data, params) {
...
let result = question_answering(dataset, {"alpha":0.05,"iterations":100})
