# Data Science - Nlp: Text Classification
...
# Text Classification specific implementation
fun text_classification(data, params) {
...
let result = text_classification(dataset, {"alpha":0.05,"iterations":100})
