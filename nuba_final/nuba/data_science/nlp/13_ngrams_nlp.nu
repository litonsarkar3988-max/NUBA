...
# Ngrams Nlp specific implementation
fun ngrams_nlp(data, params) {
    print("Running: Ngrams Nlp")
...
let result = ngrams_nlp(dataset, {"alpha":0.05,"iterations":100})
