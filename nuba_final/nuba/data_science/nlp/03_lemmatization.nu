# Data Science - Nlp: Lemmatization
...
# Lemmatization specific implementation
fun lemmatization(data, params) {
...
let result = lemmatization(dataset, {"alpha":0.05,"iterations":100})
