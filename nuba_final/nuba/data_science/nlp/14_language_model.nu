# Data Science - Nlp: Language Model
...
# Language Model specific implementation
fun language_model(data, params) {
...
let result = language_model(dataset, {"alpha":0.05,"iterations":100})
