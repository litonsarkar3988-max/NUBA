...
# Lda Nlp specific implementation
fun lda_nlp(data, params) {
    print("Running: Lda Nlp")
...
let result = lda_nlp(dataset, {"alpha":0.05,"iterations":100})
