...
# Coreference specific implementation
fun coreference(data, params) {
    print("Running: Coreference")
...
let result = coreference(dataset, {"alpha":0.05,"iterations":100})
