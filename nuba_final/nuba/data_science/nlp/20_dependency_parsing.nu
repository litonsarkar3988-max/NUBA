# Data Science - Nlp: Dependency Parsing
...
# Dependency Parsing specific implementation
fun dependency_parsing(data, params) {
...
let result = dependency_parsing(dataset, {"alpha":0.05,"iterations":100})
