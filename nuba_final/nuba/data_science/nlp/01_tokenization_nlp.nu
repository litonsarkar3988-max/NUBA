# Data Science - Nlp: Tokenization Nlp

print("=== Tokenization Nlp ===")
...
# Tokenization Nlp specific implementation
fun tokenization_nlp(data, params) {
    print("Running: Tokenization Nlp")
...
let result = tokenization_nlp(dataset, {"alpha":0.05,"iterations":100})
