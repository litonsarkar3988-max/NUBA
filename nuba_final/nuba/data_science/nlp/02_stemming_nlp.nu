...
# Stemming Nlp specific implementation
fun stemming_nlp(data, params) {
    print("Running: Stemming Nlp")
...
let result = stemming_nlp(dataset, {"alpha":0.05,"iterations":100})
