# Data Science - Nlp: Topic Modeling
...
# Topic Modeling specific implementation
fun topic_modeling(data, params) {
...
let result = topic_modeling(dataset, {"alpha":0.05,"iterations":100})
