# Data Science - Ml Algorithms: Gradient Boosting
...
# Gradient Boosting specific implementation
fun gradient_boosting(data, params) {
...
let result = gradient_boosting(dataset, {"alpha":0.05,"iterations":100})
