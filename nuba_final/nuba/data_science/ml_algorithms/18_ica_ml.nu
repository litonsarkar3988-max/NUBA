# Data Science - Ml Algorithms: Ica Ml
...
# Ica Ml specific implementation
fun ica_ml(data, params) {
    print("Running: Ica Ml")
...
let result = ica_ml(dataset, {"alpha":0.05,"iterations":100})
