# Data Science - Ml Algorithms: Gaussian Mixture
...
# Gaussian Mixture specific implementation
fun gaussian_mixture(data, params) {
...
let result = gaussian_mixture(dataset, {"alpha":0.05,"iterations":100})
