# Data Science - Ml Algorithms: Kmeans Ml
...
# Kmeans Ml specific implementation
fun kmeans_ml(data, params) {
    print("Running: Kmeans Ml")
...
let result = kmeans_ml(dataset, {"alpha":0.05,"iterations":100})
