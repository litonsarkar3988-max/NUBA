# Data Science - Ml Algorithms: Vae Concept
...
# Vae Concept specific implementation
fun vae_concept(data, params) {
    print("Running: Vae Concept")
...
let result = vae_concept(dataset, {"alpha":0.05,"iterations":100})
