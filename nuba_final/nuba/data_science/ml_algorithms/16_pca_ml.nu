# Data Science - Ml Algorithms: Pca Ml
...
# Pca Ml specific implementation
fun pca_ml(data, params) {
    print("Running: Pca Ml")
...
let result = pca_ml(dataset, {"alpha":0.05,"iterations":100})
