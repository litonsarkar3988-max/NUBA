# Data Science - Ml Algorithms: Naive Bayes Ml

print("=== Naive Bayes Ml ===")
...
# Naive Bayes Ml specific implementation
fun naive_bayes_ml(data, params) {
    print("Running: Naive Bayes Ml")
...
let result = naive_bayes_ml(dataset, {"alpha":0.05,"iterations":100})
