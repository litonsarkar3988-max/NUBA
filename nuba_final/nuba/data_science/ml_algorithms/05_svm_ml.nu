# Data Science - Ml Algorithms: Svm Ml
...
# Svm Ml specific implementation
fun svm_ml(data, params) {
    print("Running: Svm Ml")
...
let result = svm_ml(dataset, {"alpha":0.05,"iterations":100})
