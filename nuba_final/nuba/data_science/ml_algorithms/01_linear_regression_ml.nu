# Data Science - Ml Algorithms: Linear Regression Ml
...
# Linear Regression Ml specific implementation
fun linear_regression_ml(data, params) {
    print("Running: Linear Regression Ml")
...
let result = linear_regression_ml(dataset, {"alpha":0.05,"iterations":100})
