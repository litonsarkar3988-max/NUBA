# Data Science - Ml Algorithms: Knn Ml
...
# Knn Ml specific implementation
fun knn_ml(data, params) {
    print("Running: Knn Ml")
...
let result = knn_ml(dataset, {"alpha":0.05,"iterations":100})
