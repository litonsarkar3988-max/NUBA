# Data Science - Ml Algorithms: Lda Ml
...
# Lda Ml specific implementation
fun lda_ml(data, params) {
    print("Running: Lda Ml")
...
let result = lda_ml(dataset, {"alpha":0.05,"iterations":100})
