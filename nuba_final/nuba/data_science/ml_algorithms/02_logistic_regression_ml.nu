# Data Science - Ml Algorithms: Logistic Regression Ml
...
# Logistic Regression Ml specific implementation
fun logistic_regression_ml(data, params) {
    print("Running: Logistic Regression Ml")
...
let result = logistic_regression_ml(dataset, {"alpha":0.05,"iterations":100})
