# Data Science - Ml Algorithms: Random Forest Ml
...
# Random Forest Ml specific implementation
fun random_forest_ml(data, params) {
    print("Running: Random Forest Ml")
...
let result = random_forest_ml(dataset, {"alpha":0.05,"iterations":100})
