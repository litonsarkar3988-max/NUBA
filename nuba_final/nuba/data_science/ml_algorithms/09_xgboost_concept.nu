# Data Science - Ml Algorithms: Xgboost Concept

print("=== Xgboost Concept ===")
...
# Xgboost Concept specific implementation
fun xgboost_concept(data, params) {
    print("Running: Xgboost Concept")
...
let result = xgboost_concept(dataset, {"alpha":0.05,"iterations":100})
