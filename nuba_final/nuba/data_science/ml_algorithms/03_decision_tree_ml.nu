# Data Science - Ml Algorithms: Decision Tree Ml
...
# Decision Tree Ml specific implementation
fun decision_tree_ml(data, params) {
    print("Running: Decision Tree Ml")
...
let result = decision_tree_ml(dataset, {"alpha":0.05,"iterations":100})
