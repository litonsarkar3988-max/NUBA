# Data Science - Recommendation: Svd Rec
...
# Svd Rec specific implementation
fun svd_rec(data, params) {
    print("Running: Svd Rec")
...
let result = svd_rec(dataset, {"alpha":0.05,"iterations":100})
