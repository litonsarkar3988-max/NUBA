# Data Science - Recommendation: User Based Cf
...
# User Based Cf specific implementation
fun user_based_cf(data, params) {
...
let result = user_based_cf(dataset, {"alpha":0.05,"iterations":100})
