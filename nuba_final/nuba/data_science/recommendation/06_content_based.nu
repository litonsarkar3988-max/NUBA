# Data Science - Recommendation: Content Based
...
# Content Based specific implementation
fun content_based(data, params) {
    print("Running: Content Based")
...
let result = content_based(dataset, {"alpha":0.05,"iterations":100})
