# Data Science - Recommendation: Collaborative Filtering
...
# Collaborative Filtering specific implementation
fun collaborative_filtering(data, params) {
...
let result = collaborative_filtering(dataset, {"alpha":0.05,"iterations":100})
