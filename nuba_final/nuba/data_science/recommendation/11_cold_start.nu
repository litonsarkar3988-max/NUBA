# Data Science - Recommendation: Cold Start
...
# Cold Start specific implementation
fun cold_start(data, params) {
...
let result = cold_start(dataset, {"alpha":0.05,"iterations":100})
