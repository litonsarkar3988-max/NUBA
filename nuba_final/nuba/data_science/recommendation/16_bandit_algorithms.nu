# Data Science - Recommendation: Bandit Algorithms
...
# Bandit Algorithms specific implementation
fun bandit_algorithms(data, params) {
    print("Running: Bandit Algorithms")
...
let result = bandit_algorithms(dataset, {"alpha":0.05,"iterations":100})
