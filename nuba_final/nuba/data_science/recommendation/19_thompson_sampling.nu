# Data Science - Recommendation: Thompson Sampling
...
# Thompson Sampling specific implementation
fun thompson_sampling(data, params) {
...
let result = thompson_sampling(dataset, {"alpha":0.05,"iterations":100})
