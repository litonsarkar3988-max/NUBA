# Data Science - Recommendation: Hybrid Filtering
...
# Hybrid Filtering specific implementation
fun hybrid_filtering(data, params) {
    print("Running: Hybrid Filtering")
...
let result = hybrid_filtering(dataset, {"alpha":0.05,"iterations":100})
