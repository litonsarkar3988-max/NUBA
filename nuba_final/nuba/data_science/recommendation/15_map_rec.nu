# Data Science - Recommendation: Map Rec
...
# Map Rec specific implementation
fun map_rec(data, params) {
    print("Running: Map Rec")
...
let result = map_rec(dataset, {"alpha":0.05,"iterations":100})
