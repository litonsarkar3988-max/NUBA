# Data Science - Recommendation: Multi Armed Bandit
...
# Multi Armed Bandit specific implementation
fun multi_armed_bandit(data, params) {
    print("Running: Multi Armed Bandit")
...
let result = multi_armed_bandit(dataset, {"alpha":0.05,"iterations":100})
