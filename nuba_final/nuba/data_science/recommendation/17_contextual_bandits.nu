# Data Science - Recommendation: Contextual Bandits
...
# Contextual Bandits specific implementation
fun contextual_bandits(data, params) {
    print("Running: Contextual Bandits")
...
let result = contextual_bandits(dataset, {"alpha":0.05,"iterations":100})
