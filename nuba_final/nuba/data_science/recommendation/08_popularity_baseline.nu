# Data Science - Recommendation: Popularity Baseline
...
# Popularity Baseline specific implementation
fun popularity_baseline(data, params) {
...
let result = popularity_baseline(dataset, {"alpha":0.05,"iterations":100})
