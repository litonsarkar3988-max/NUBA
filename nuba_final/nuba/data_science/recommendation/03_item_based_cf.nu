# Data Science - Recommendation: Item Based Cf
...
# Item Based Cf specific implementation
fun item_based_cf(data, params) {
...
let result = item_based_cf(dataset, {"alpha":0.05,"iterations":100})
