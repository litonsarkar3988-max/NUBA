# Data Science - Time Series: Rmse Ts
...
# Rmse Ts specific implementation
fun rmse_ts(data, params) {
    print("Running: Rmse Ts")
...
let result = rmse_ts(dataset, {"alpha":0.05,"iterations":100})
