# Data Science - Time Series: Forecasting Eval
...
# Forecasting Eval specific implementation
fun forecasting_eval(data, params) {
    print("Running: Forecasting Eval")
...
let result = forecasting_eval(dataset, {"alpha":0.05,"iterations":100})
