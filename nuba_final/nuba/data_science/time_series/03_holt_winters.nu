# Data Science - Time Series: Holt Winters
...
# Holt Winters specific implementation
fun holt_winters(data, params) {
...
let result = holt_winters(dataset, {"alpha":0.05,"iterations":100})
