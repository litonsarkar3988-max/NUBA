# Data Science - Time Series: Granger Causality
...
# Granger Causality specific implementation
fun granger_causality(data, params) {
...
let result = granger_causality(dataset, {"alpha":0.05,"iterations":100})
