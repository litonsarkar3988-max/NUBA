# Data Science - Time Series: Spectral Analysis
...
# Spectral Analysis specific implementation
fun spectral_analysis(data, params) {
...
let result = spectral_analysis(dataset, {"alpha":0.05,"iterations":100})
