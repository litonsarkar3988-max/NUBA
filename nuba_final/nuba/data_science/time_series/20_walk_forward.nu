# Data Science - Time Series: Walk Forward
...
# Walk Forward specific implementation
fun walk_forward(data, params) {
...
let result = walk_forward(dataset, {"alpha":0.05,"iterations":100})
