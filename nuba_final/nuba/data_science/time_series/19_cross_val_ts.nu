# Data Science - Time Series: Cross Val Ts
...
# Cross Val Ts specific implementation
fun cross_val_ts(data, params) {
    print("Running: Cross Val Ts")
...
let result = cross_val_ts(dataset, {"alpha":0.05,"iterations":100})
