# Data Science - Time Series: Cointegration
...
# Cointegration specific implementation
fun cointegration(data, params) {
    print("Running: Cointegration")
...
let result = cointegration(dataset, {"alpha":0.05,"iterations":100})
