# Data Science - Time Series: Stationarity Test
...
# Stationarity Test specific implementation
fun stationarity_test(data, params) {
...
let result = stationarity_test(dataset, {"alpha":0.05,"iterations":100})
