# Data Science - Time Series: Wavelet Ts
...
# Wavelet Ts specific implementation
fun wavelet_ts(data, params) {
    print("Running: Wavelet Ts")
...
let result = wavelet_ts(dataset, {"alpha":0.05,"iterations":100})
