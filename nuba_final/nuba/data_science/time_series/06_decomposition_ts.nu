# Data Science - Time Series: Decomposition Ts

print("=== Decomposition Ts ===")
...
# Decomposition Ts specific implementation
fun decomposition_ts(data, params) {
    print("Running: Decomposition Ts")
...
let result = decomposition_ts(dataset, {"alpha":0.05,"iterations":100})
