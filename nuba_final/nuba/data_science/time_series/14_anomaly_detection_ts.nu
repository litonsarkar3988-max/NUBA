# Data Science - Time Series: Anomaly Detection Ts

print("=== Anomaly Detection Ts ===")
...
# Anomaly Detection Ts specific implementation
fun anomaly_detection_ts(data, params) {
    print("Running: Anomaly Detection Ts")
...
let result = anomaly_detection_ts(dataset, {"alpha":0.05,"iterations":100})
