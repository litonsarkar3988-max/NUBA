# Data Science - Time Series: Differencing
...
# Differencing specific implementation
fun differencing(data, params) {
    print("Running: Differencing")
...
let result = differencing(dataset, {"alpha":0.05,"iterations":100})
