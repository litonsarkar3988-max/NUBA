# Data Science - Time Series: Arima Ts
...
# Arima Ts specific implementation
fun arima_ts(data, params) {
    print("Running: Arima Ts")
...
let result = arima_ts(dataset, {"alpha":0.05,"iterations":100})
