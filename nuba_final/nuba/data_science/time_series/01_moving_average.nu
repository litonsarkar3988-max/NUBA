# Data Science - Time Series: Moving Average
...
# Moving Average specific implementation
fun moving_average(data, params) {
...
let result = moving_average(dataset, {"alpha":0.05,"iterations":100})
