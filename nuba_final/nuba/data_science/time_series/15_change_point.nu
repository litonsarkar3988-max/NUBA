# Data Science - Time Series: Change Point
...
# Change Point specific implementation
fun change_point(data, params) {
    print("Running: Change Point")
...
let result = change_point(dataset, {"alpha":0.05,"iterations":100})
