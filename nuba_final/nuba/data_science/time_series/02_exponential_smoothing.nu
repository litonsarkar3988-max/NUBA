# Data Science - Time Series: Exponential Smoothing
...
# Exponential Smoothing specific implementation
fun exponential_smoothing(data, params) {
...
let result = exponential_smoothing(dataset, {"alpha":0.05,"iterations":100})
