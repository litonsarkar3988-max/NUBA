# Data Science - Statistics: Feature Scaling
...
# Feature Scaling specific implementation
fun feature_scaling(data, params) {
...
let result = feature_scaling(dataset, {"alpha":0.05,"iterations":100})
