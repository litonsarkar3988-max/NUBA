# Data Science - Statistics: Time Series Decomp

print("=== Time Series Decomp ===")
...
# Time Series Decomp specific implementation
fun time_series_decomp(data, params) {
    print("Running: Time Series Decomp")
...
let result = time_series_decomp(dataset, {"alpha":0.05,"iterations":100})
