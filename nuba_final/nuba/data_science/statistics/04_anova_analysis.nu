# Data Science - Statistics: Anova Analysis
...
# Anova Analysis specific implementation
fun anova_analysis(data, params) {
...
let result = anova_analysis(dataset, {"alpha":0.05,"iterations":100})
