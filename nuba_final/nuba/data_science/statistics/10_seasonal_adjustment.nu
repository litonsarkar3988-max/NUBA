# Data Science - Statistics: Seasonal Adjustment
...
# Seasonal Adjustment specific implementation
fun seasonal_adjustment(data, params) {
...
let result = seasonal_adjustment(dataset, {"alpha":0.05,"iterations":100})
