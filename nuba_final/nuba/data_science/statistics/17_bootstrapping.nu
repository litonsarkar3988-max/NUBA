# Data Science - Statistics: Bootstrapping
...
# Bootstrapping specific implementation
fun bootstrapping(data, params) {
...
let result = bootstrapping(dataset, {"alpha":0.05,"iterations":100})
