# Data Science - Statistics: Inferential Stats
...
# Inferential Stats specific implementation
fun inferential_stats(data, params) {
    print("Running: Inferential Stats")
...
let result = inferential_stats(dataset, {"alpha":0.05,"iterations":100})
