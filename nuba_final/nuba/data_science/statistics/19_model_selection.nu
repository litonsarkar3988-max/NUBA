# Data Science - Statistics: Model Selection
...
# Model Selection specific implementation
fun model_selection(data, params) {
...
let result = model_selection(dataset, {"alpha":0.05,"iterations":100})
