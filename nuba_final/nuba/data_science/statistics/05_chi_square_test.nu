# Data Science - Statistics: Chi Square Test
...
# Chi Square Test specific implementation
fun chi_square_test(data, params) {
...
let result = chi_square_test(dataset, {"alpha":0.05,"iterations":100})
