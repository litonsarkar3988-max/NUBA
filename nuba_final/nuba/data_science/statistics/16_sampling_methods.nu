# Data Science - Statistics: Sampling Methods
...
# Sampling Methods specific implementation
fun sampling_methods(data, params) {
    print("Running: Sampling Methods")
...
let result = sampling_methods(dataset, {"alpha":0.05,"iterations":100})
