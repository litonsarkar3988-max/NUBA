# Data Science - Statistics: Outlier Detection
...
# Outlier Detection specific implementation
fun outlier_detection(data, params) {
...
let result = outlier_detection(dataset, {"alpha":0.05,"iterations":100})
