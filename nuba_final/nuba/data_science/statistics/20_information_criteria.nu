# Data Science - Statistics: Information Criteria
...
# Information Criteria specific implementation
fun information_criteria(data, params) {
    print("Running: Information Criteria")
...
let result = information_criteria(dataset, {"alpha":0.05,"iterations":100})
