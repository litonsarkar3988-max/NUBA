# Data Science - Statistics: Cross Validation
...
# Cross Validation specific implementation
fun cross_validation(data, params) {
...
let result = cross_validation(dataset, {"alpha":0.05,"iterations":100})
