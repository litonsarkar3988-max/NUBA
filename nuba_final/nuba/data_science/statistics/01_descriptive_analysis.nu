# Data Science - Statistics: Descriptive Analysis
...
# Descriptive Analysis specific implementation
fun descriptive_analysis(data, params) {
...
let result = descriptive_analysis(dataset, {"alpha":0.05,"iterations":100})
