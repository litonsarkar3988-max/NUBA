# Data Science - Statistics: Hypothesis Tests
...
# Hypothesis Tests specific implementation
fun hypothesis_tests(data, params) {
...
let result = hypothesis_tests(dataset, {"alpha":0.05,"iterations":100})
