# Data Science - Statistics: Data Normalization
...
# Data Normalization specific implementation
fun data_normalization(data, params) {
...
let result = data_normalization(dataset, {"alpha":0.05,"iterations":100})
