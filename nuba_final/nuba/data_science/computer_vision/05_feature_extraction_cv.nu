# Data Science - Computer Vision: Feature Extraction Cv

print("=== Feature Extraction Cv ===")
...
# Feature Extraction Cv specific implementation
fun feature_extraction_cv(data, params) {
    print("Running: Feature Extraction Cv")
...
let result = feature_extraction_cv(dataset, {"alpha":0.05,"iterations":100})
