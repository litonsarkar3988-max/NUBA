# Data Science - Computer Vision: Image Loading
...
# Image Loading specific implementation
fun image_loading(data, params) {
    print("Running: Image Loading")
...
let result = image_loading(dataset, {"alpha":0.05,"iterations":100})
