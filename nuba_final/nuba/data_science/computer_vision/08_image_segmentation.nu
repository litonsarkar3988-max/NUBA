# Data Science - Computer Vision: Image Segmentation
...
# Image Segmentation specific implementation
fun image_segmentation(data, params) {
...
let result = image_segmentation(dataset, {"alpha":0.05,"iterations":100})
