# Data Science - Computer Vision: Template Matching
...
# Template Matching specific implementation
fun template_matching(data, params) {
...
let result = template_matching(dataset, {"alpha":0.05,"iterations":100})
