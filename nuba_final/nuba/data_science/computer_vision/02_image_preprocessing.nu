# Data Science - Computer Vision: Image Preprocessing
...
# Image Preprocessing specific implementation
fun image_preprocessing(data, params) {
...
let result = image_preprocessing(dataset, {"alpha":0.05,"iterations":100})
