# Data Science - Computer Vision: Optical Flow
...
# Optical Flow specific implementation
fun optical_flow(data, params) {
...
let result = optical_flow(dataset, {"alpha":0.05,"iterations":100})
