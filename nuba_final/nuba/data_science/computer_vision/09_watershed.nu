# Data Science - Computer Vision: Watershed
...
# Watershed specific implementation
fun watershed(data, params) {
...
let result = watershed(dataset, {"alpha":0.05,"iterations":100})
