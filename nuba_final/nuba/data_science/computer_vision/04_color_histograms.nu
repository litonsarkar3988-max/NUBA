# Data Science - Computer Vision: Color Histograms
...
# Color Histograms specific implementation
fun color_histograms(data, params) {
    print("Running: Color Histograms")
...
let result = color_histograms(dataset, {"alpha":0.05,"iterations":100})
