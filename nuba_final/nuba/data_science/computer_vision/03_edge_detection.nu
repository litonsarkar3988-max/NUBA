# Data Science - Computer Vision: Edge Detection
...
# Edge Detection specific implementation
fun edge_detection(data, params) {
...
let result = edge_detection(dataset, {"alpha":0.05,"iterations":100})
