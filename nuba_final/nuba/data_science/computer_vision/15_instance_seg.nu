# Data Science - Computer Vision: Instance Seg
...
# Instance Seg specific implementation
fun instance_seg(data, params) {
    print("Running: Instance Seg")
...
let result = instance_seg(dataset, {"alpha":0.05,"iterations":100})
