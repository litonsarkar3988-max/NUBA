# Data Science - Computer Vision: Semantic Seg
...
# Semantic Seg specific implementation
fun semantic_seg(data, params) {
    print("Running: Semantic Seg")
...
let result = semantic_seg(dataset, {"alpha":0.05,"iterations":100})
