# Data Science - Computer Vision: Normalization Cv

print("=== Normalization Cv ===")
...
# Normalization Cv specific implementation
fun normalization_cv(data, params) {
    print("Running: Normalization Cv")
...
let result = normalization_cv(dataset, {"alpha":0.05,"iterations":100})
