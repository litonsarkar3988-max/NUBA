# Data Science - Computer Vision: Augmentation
...
# Augmentation specific implementation
fun augmentation(data, params) {
...
let result = augmentation(dataset, {"alpha":0.05,"iterations":100})
