# Data Science - Computer Vision: Transforms
...
# Transforms specific implementation
fun transforms(data, params) {
...
let result = transforms(dataset, {"alpha":0.05,"iterations":100})
