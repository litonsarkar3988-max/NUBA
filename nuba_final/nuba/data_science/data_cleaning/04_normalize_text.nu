# Data Science - Data Cleaning: Normalize Text
...
# Normalize Text specific implementation
fun normalize_text(data, params) {
    print("Running: Normalize Text")
...
let result = normalize_text(dataset, {"alpha":0.05,"iterations":100})
