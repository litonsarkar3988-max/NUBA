# Data Science - Data Cleaning: One Hot Encoding
...
# One Hot Encoding specific implementation
fun one_hot_encoding(data, params) {
...
let result = one_hot_encoding(dataset, {"alpha":0.05,"iterations":100})
