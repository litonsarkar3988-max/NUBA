# Data Science - Data Cleaning: Cap Outliers
...
# Cap Outliers specific implementation
fun cap_outliers(data, params) {
    print("Running: Cap Outliers")
...
let result = cap_outliers(dataset, {"alpha":0.05,"iterations":100})
