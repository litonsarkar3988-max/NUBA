# Data Science - Data Cleaning: Standardize Values
...
# Standardize Values specific implementation
fun standardize_values(data, params) {
    print("Running: Standardize Values")
...
let result = standardize_values(dataset, {"alpha":0.05,"iterations":100})
