# Data Science - Data Cleaning: Regex Cleaning
...
# Regex Cleaning specific implementation
fun regex_cleaning(data, params) {
    print("Running: Regex Cleaning")
...
let result = regex_cleaning(dataset, {"alpha":0.05,"iterations":100})
