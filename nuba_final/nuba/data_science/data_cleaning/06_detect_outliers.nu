# Data Science - Data Cleaning: Detect Outliers
...
# Detect Outliers specific implementation
fun detect_outliers(data, params) {
    print("Running: Detect Outliers")
...
let result = detect_outliers(dataset, {"alpha":0.05,"iterations":100})
