# Data Science - Data Cleaning: Encode Categorical
...
# Encode Categorical specific implementation
fun encode_categorical(data, params) {
    print("Running: Encode Categorical")
...
let result = encode_categorical(dataset, {"alpha":0.05,"iterations":100})
