# Data Science - Data Cleaning: Knn Imputation
...
# Knn Imputation specific implementation
fun knn_imputation(data, params) {
...
let result = knn_imputation(dataset, {"alpha":0.05,"iterations":100})
