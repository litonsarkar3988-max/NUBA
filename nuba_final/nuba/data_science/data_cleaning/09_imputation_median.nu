# Data Science - Data Cleaning: Imputation Median
...
# Imputation Median specific implementation
fun imputation_median(data, params) {
    print("Running: Imputation Median")
...
let result = imputation_median(dataset, {"alpha":0.05,"iterations":100})
