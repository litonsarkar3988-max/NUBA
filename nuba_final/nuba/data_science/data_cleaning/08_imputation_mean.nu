# Data Science - Data Cleaning: Imputation Mean
...
# Imputation Mean specific implementation
fun imputation_mean(data, params) {
    print("Running: Imputation Mean")
...
let result = imputation_mean(dataset, {"alpha":0.05,"iterations":100})
