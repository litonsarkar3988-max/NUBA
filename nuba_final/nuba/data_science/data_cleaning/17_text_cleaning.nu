# Data Science - Data Cleaning: Text Cleaning
...
# Text Cleaning specific implementation
fun text_cleaning(data, params) {
...
let result = text_cleaning(dataset, {"alpha":0.05,"iterations":100})
