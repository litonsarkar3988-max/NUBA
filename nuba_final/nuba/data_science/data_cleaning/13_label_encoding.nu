# Data Science - Data Cleaning: Label Encoding
...
# Label Encoding specific implementation
fun label_encoding(data, params) {
    print("Running: Label Encoding")
...
let result = label_encoding(dataset, {"alpha":0.05,"iterations":100})
