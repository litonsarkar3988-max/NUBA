# Data Science - Data Cleaning: Target Encoding
...
# Target Encoding specific implementation
fun target_encoding(data, params) {
    print("Running: Target Encoding")
...
let result = target_encoding(dataset, {"alpha":0.05,"iterations":100})
