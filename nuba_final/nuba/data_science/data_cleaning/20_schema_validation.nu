# Data Science - Data Cleaning: Schema Validation
...
# Schema Validation specific implementation
fun schema_validation(data, params) {
...
let result = schema_validation(dataset, {"alpha":0.05,"iterations":100})
