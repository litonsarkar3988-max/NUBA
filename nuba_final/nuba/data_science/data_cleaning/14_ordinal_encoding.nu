# Data Science - Data Cleaning: Ordinal Encoding
...
# Ordinal Encoding specific implementation
fun ordinal_encoding(data, params) {
    print("Running: Ordinal Encoding")
...
let result = ordinal_encoding(dataset, {"alpha":0.05,"iterations":100})
