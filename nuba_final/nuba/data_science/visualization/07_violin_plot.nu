# Data Science - Visualization: Violin Plot
...
# Violin Plot specific implementation
fun violin_plot(data, params) {
...
let result = violin_plot(dataset, {"alpha":0.05,"iterations":100})
