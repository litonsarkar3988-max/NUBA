# Data Science - Visualization: Funnel
...
# Funnel specific implementation
fun funnel(data, params) {
    print("Running: Funnel")
...
let result = funnel(dataset, {"alpha":0.05,"iterations":100})
