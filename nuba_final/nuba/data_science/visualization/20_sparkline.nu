# Data Science - Visualization: Sparkline
...
# Sparkline specific implementation
fun sparkline(data, params) {
    print("Running: Sparkline")
...
let result = sparkline(dataset, {"alpha":0.05,"iterations":100})
