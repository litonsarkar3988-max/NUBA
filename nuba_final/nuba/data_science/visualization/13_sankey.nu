# Data Science - Visualization: Sankey
...
# Sankey specific implementation
fun sankey(data, params) {
    print("Running: Sankey")
...
let result = sankey(dataset, {"alpha":0.05,"iterations":100})
