# Data Science - Visualization: Geographic Map
...
# Geographic Map specific implementation
fun geographic_map(data, params) {
    print("Running: Geographic Map")
...
let result = geographic_map(dataset, {"alpha":0.05,"iterations":100})
