# Data Science - Visualization: Candlestick
...
# Candlestick specific implementation
fun candlestick(data, params) {
    print("Running: Candlestick")
...
let result = candlestick(dataset, {"alpha":0.05,"iterations":100})
