# Data Science - Visualization: Sunburst
...
# Sunburst specific implementation
fun sunburst(data, params) {
    print("Running: Sunburst")
...
let result = sunburst(dataset, {"alpha":0.05,"iterations":100})
