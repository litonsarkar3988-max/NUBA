# Data Science - Visualization: Treemap Vis
...
# Treemap Vis specific implementation
fun treemap_vis(data, params) {
    print("Running: Treemap Vis")
...
let result = treemap_vis(dataset, {"alpha":0.05,"iterations":100})
