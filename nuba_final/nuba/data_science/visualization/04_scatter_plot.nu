# Data Science - Visualization: Scatter Plot
...
# Scatter Plot specific implementation
fun scatter_plot(data, params) {
...
let result = scatter_plot(dataset, {"alpha":0.05,"iterations":100})
