# Data Science - Visualization: Bubble Chart
...
fun bubble_chart(data, params) {
    print("Running: Bubble Chart")
...
let result = bubble_chart(dataset, {"alpha":0.05,"iterations":100})
