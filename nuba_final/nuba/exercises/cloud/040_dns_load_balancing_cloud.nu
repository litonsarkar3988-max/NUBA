# Cloud Computing: Dns Load Balancing Cloud

print("=== Dns Load Balancing Cloud ===")
...
# Demo for Dns Load Balancing Cloud
let infra = new CloudInfrastructure("Dns Load Balancing Cloud Infra")
