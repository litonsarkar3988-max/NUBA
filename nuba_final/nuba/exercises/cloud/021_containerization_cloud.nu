# Cloud Computing: Containerization Cloud

print("=== Containerization Cloud ===")
...
# Demo for Containerization Cloud
let infra = new CloudInfrastructure("Containerization Cloud Infra")
