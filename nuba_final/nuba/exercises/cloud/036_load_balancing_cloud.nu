# Cloud Computing: Load Balancing Cloud

print("=== Load Balancing Cloud ===")
...
# Demo for Load Balancing Cloud
let infra = new CloudInfrastructure("Load Balancing Cloud Infra")
