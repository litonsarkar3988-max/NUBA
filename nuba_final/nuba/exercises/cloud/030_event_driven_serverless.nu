# Cloud Computing: Event Driven Serverless

print("=== Event Driven Serverless ===")
...
# Demo for Event Driven Serverless
let infra = new CloudInfrastructure("Event Driven Serverless Infra")
