# Data Structure 30: Leftist Heap
# Leftist property heap

class LeftistHeap {
    fun init(self) {
        self.data = []
        self.size = 0
        self.name = "Leftist Heap"
    }
    ...
    fun describe(self) {
        return "Leftist Heap: " + str(self.size) + " elements"
    }
}

# Demo: Leftist property heap
let ds = new LeftistHeap()
