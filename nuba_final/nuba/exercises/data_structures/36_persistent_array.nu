# Data Structure 36: Persistent Array
# Immutable versioned array

class PersistentArray {
    fun init(self) {
        self.data = []
        self.size = 0
        self.name = "Persistent Array"
    }
    ...
    fun describe(self) {
        return "Persistent Array: " + str(self.size) + " elements"
    }
}

# Demo: Immutable versioned array
let ds = new PersistentArray()
