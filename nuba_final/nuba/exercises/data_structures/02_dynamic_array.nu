# Data Structure 02: Dynamic Array
...
class DynamicArray {
    ...
    fun describe(self) {
        return "Dynamic Array: " + str(self.size) + " elements"
    }
}

# Demo: Resizable array implementation
let ds = new DynamicArray()
