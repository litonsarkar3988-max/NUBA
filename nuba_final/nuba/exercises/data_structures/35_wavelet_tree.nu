# Data Structure 35: Wavelet Tree
# Range query on sequences

class WaveletTree {
    fun init(self) {
        self.data = []
        self.size = 0
        self.name = "Wavelet Tree"
    }
    ...
    fun describe(self) {
        return "Wavelet Tree: " + str(self.size) + " elements"
    }
}

# Demo: Range query on sequences
let ds = new WaveletTree()
