# Data Structure 37: Persistent Stack
# Functional stack
...
class PersistentStack {
    ...
    fun describe(self) {
        return "Persistent Stack: " + str(self.size) + " elements"
    }
}

# Demo: Functional stack
let ds = new PersistentStack()
