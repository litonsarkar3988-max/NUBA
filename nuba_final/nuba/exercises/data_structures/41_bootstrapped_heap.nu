# Data Structure 41: Bootstrapped Heap
# Recursive heap

class BootstrappedHeap {
    fun init(self) {
        self.data = []
        self.size = 0
        self.name = "Bootstrapped Heap"
    }
    ...
    fun describe(self) {
        return "Bootstrapped Heap: " + str(self.size) + " elements"
    }
}

# Demo: Recursive heap
let ds = new BootstrappedHeap()
