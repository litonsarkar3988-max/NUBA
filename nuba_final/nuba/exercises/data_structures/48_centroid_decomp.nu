# Data Structure 48: Centroid Decomposition
# Tree distances
...
class CentroidDecomposition {
    fun init(self) {
        self.data = []
        self.size = 0
        self.name = "Centroid Decomposition"
    }
    ...
    fun describe(self) {
        return "Centroid Decomposition: " + str(self.size) + " elements"
    }
}

# Demo: Tree distances
let ds = new CentroidDecomposition()
