# Data Structure 49: Small-to-Large Merging
# DSU on trees

class SmalltoLargeMerging {
    fun init(self) {
        self.data = []
        self.size = 0
        self.name = "Small-to-Large Merging"
    }
    ...
    fun describe(self) {
        return "Small-to-Large Merging: " + str(self.size) + " elements"
    }
}

# Demo: DSU on trees
let ds = new SmalltoLargeMerging()
