# Data Structure 01: Array Rotation
...
class ArrayRotation {
    ...
    fun describe(self) {
        return "Array Rotation: " + str(self.size) + " elements"
    }
}

# Demo: Rotate array left and right
let ds = new ArrayRotation()
