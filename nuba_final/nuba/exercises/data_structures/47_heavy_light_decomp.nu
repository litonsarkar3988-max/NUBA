# Data Structure 47: Heavy-Light Decomposition
# Path queries
...
class HeavyLightDecomposition {
    fun init(self) {
        self.data = []
        self.size = 0
        self.name = "Heavy-Light Decomposition"
    }
    ...
    fun describe(self) {
        return "Heavy-Light Decomposition: " + str(self.size) + " elements"
    }
}

# Demo: Path queries
let ds = new HeavyLightDecomposition()
