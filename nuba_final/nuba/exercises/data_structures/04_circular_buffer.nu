# Data Structure 04: Circular Buffer
...
class CircularBuffer {
    ...
    fun describe(self) {
        return "Circular Buffer: " + str(self.size) + " elements"
    }
}

# Demo: Ring buffer implementation
let ds = new CircularBuffer()
