# Functional Exercise 05: Filter predicate patterns

# Filter predicate patterns

# Core function
fun 05_filter_examples(data) {
...
# Demonstrate 05 filter examples
print("=== Filter predicate patterns ===")
