# Functional Exercise 14: Maybe/Option pattern for null safety

# Maybe/Option pattern for null safety

# Core function
fun 14_maybe_pattern(data) {
...
# Demonstrate 14 maybe pattern
print("=== Maybe/Option pattern for null safety ===")
