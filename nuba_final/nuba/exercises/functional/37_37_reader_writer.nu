# Functional Exercise 37: Reader/Writer monad concept

# Reader/Writer monad concept

# Core function
fun 37_reader_writer(data) {
...
# Demonstrate 37 reader writer
print("=== Reader/Writer monad concept ===")
