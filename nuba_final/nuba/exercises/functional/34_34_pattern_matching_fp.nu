# Functional Exercise 34: Pattern matching in FP style

# Pattern matching in FP style

# Core function
fun 34_pattern_matching_fp(data) {
...
# Demonstrate 34 pattern matching fp
print("=== Pattern matching in FP style ===")
