# Functional Exercise 32: Product types with tuples

# Product types with tuples

# Core function
fun 32_product_types(data) {
...
# Demonstrate 32 product types
print("=== Product types with tuples ===")
