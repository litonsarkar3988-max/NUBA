# Functional Exercise 28: Fold patterns: foldl, foldr

# Fold patterns: foldl, foldr

# Core function
fun 28_fold_patterns(data) {
...
# Demonstrate 28 fold patterns
print("=== Fold patterns: foldl, foldr ===")
