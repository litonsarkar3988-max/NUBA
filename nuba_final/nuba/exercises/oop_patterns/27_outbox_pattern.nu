# OOP Pattern: Outbox Pattern
# Pattern #27 in the advanced OOP patterns series

class OutboxpatternBase {
...
class OutboxpatternImpl(OutboxpatternBase) {
    fun init(self) {
        super.init({"pattern":"outbox_pattern","version":"1.0"})
    }
    fun run(self) {
        print("Running: Outbox Pattern")
...
let impl = new OutboxpatternImpl()
