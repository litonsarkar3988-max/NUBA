# OOP Pattern: Null Object Detail
# Pattern #11 in the advanced OOP patterns series

class NullobjectdetailBase {
...
class NullobjectdetailImpl(NullobjectdetailBase) {
    fun init(self) {
        super.init({"pattern":"null_object_detail","version":"1.0"})
    }
    fun run(self) {
        print("Running: Null Object Detail")
...
let impl = new NullobjectdetailImpl()
