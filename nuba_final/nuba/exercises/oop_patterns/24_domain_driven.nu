# OOP Pattern: Domain Driven
# Pattern #24 in the advanced OOP patterns series

class DomaindrivenBase {
...
class DomaindrivenImpl(DomaindrivenBase) {
    fun init(self) {
        super.init({"pattern":"domain_driven","version":"1.0"})
    }
    fun run(self) {
        print("Running: Domain Driven")
