# OOP Pattern: Entity Component
# Pattern #20 in the advanced OOP patterns series
...
class EntitycomponentImpl(EntitycomponentBase) {
    fun init(self) {
        super.init({"pattern":"entity_component","version":"1.0"})
    }
    fun run(self) {
        print("Running: Entity Component")
...
let impl = new EntitycomponentImpl()
