# OOP Pattern: Object Pool
# Pattern #12 in the advanced OOP patterns series
...
class ObjectpoolImpl(ObjectpoolBase) {
    fun init(self) {
        super.init({"pattern":"object_pool","version":"1.0"})
    }
    fun run(self) {
        print("Running: Object Pool")
