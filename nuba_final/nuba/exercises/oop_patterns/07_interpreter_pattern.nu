# OOP Pattern: Interpreter Pattern
# Pattern #7 in the advanced OOP patterns series

class InterpreterpatternBase {
...
class InterpreterpatternImpl(InterpreterpatternBase) {
    fun init(self) {
        super.init({"pattern":"interpreter_pattern","version":"1.0"})
    }
    fun run(self) {
        print("Running: Interpreter Pattern")
...
let impl = new InterpreterpatternImpl()
