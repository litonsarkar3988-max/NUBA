...
# Pattern #1 in the advanced OOP patterns series
...
class AbstractfactoryImpl(AbstractfactoryBase) {
    fun init(self) {
        super.init({"pattern":"abstract_factory","version":"1.0"})
    }
    fun run(self) {
        print("Running: Abstract Factory")
...
let impl = new AbstractfactoryImpl()
