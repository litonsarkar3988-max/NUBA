# OOP Pattern: Event Driven Arch
# Pattern #21 in the advanced OOP patterns series

class EventdrivenarchBase {
...
class EventdrivenarchImpl(EventdrivenarchBase) {
    fun init(self) {
        super.init({"pattern":"event_driven_arch","version":"1.0"})
    }
    fun run(self) {
        print("Running: Event Driven Arch")
...
let impl = new EventdrivenarchImpl()
