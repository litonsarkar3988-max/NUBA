# OOP Pattern: Saga Pattern
# Pattern #26 in the advanced OOP patterns series

class SagapatternBase {
...
class SagapatternImpl(SagapatternBase) {
    fun init(self) {
        super.init({"pattern":"saga_pattern","version":"1.0"})
    }
    fun run(self) {
        print("Running: Saga Pattern")
