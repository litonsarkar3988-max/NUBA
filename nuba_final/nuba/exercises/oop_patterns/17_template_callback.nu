# OOP Pattern: Template Callback
# Pattern #17 in the advanced OOP patterns series

class TemplatecallbackBase {
...
class TemplatecallbackImpl(TemplatecallbackBase) {
    fun init(self) {
        super.init({"pattern":"template_callback","version":"1.0"})
    }
    fun run(self) {
        print("Running: Template Callback")
...
let impl = new TemplatecallbackImpl()
