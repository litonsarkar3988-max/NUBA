# OOP Pattern: Iterator Pattern
# Pattern #8 in the advanced OOP patterns series

class IteratorpatternBase {
...
class IteratorpatternImpl(IteratorpatternBase) {
    fun init(self) {
        super.init({"pattern":"iterator_pattern","version":"1.0"})
    }
    fun run(self) {
        print("Running: Iterator Pattern")
...
let impl = new IteratorpatternImpl()
