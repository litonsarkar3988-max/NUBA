# OOP Pattern: Prototype Pattern
# Pattern #3 in the advanced OOP patterns series

class PrototypepatternBase {
...
class PrototypepatternImpl(PrototypepatternBase) {
    fun init(self) {
        super.init({"pattern":"prototype_pattern","version":"1.0"})
    }
    fun run(self) {
        print("Running: Prototype Pattern")
...
let impl = new PrototypepatternImpl()
