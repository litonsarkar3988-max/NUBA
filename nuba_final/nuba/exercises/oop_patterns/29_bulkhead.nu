# OOP Pattern: Bulkhead
# Pattern #29 in the advanced OOP patterns series
...
class BulkheadImpl(BulkheadBase) {
    fun init(self) {
        super.init({"pattern":"bulkhead","version":"1.0"})
    }
    fun run(self) {
