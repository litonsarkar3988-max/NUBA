# OOP Pattern: Memento Detail
# Pattern #10 in the advanced OOP patterns series

class MementodetailBase {
...
class MementodetailImpl(MementodetailBase) {
    fun init(self) {
        super.init({"pattern":"memento_detail","version":"1.0"})
    }
    fun run(self) {
        print("Running: Memento Detail")
...
let impl = new MementodetailImpl()
