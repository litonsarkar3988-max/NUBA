# OOP Pattern: Hexagonal Arch
# Pattern #22 in the advanced OOP patterns series

class HexagonalarchBase {
...
class HexagonalarchImpl(HexagonalarchBase) {
    fun init(self) {
        super.init({"pattern":"hexagonal_arch","version":"1.0"})
    }
    fun run(self) {
        print("Running: Hexagonal Arch")
...
let impl = new HexagonalarchImpl()
