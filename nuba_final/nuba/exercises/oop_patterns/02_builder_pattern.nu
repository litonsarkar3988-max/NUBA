# OOP Pattern: Builder Pattern
# Pattern #2 in the advanced OOP patterns series

class BuilderpatternBase {
...
class BuilderpatternImpl(BuilderpatternBase) {
    fun init(self) {
        super.init({"pattern":"builder_pattern","version":"1.0"})
    }
    fun run(self) {
        print("Running: Builder Pattern")
...
let impl = new BuilderpatternImpl()
