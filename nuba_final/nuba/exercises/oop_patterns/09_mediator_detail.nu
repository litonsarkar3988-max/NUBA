# OOP Pattern: Mediator Detail
# Pattern #9 in the advanced OOP patterns series

class MediatordetailBase {
...
class MediatordetailImpl(MediatordetailBase) {
    fun init(self) {
        super.init({"pattern":"mediator_detail","version":"1.0"})
    }
    fun run(self) {
        print("Running: Mediator Detail")
...
let impl = new MediatordetailImpl()
