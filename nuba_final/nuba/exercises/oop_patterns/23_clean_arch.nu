# OOP Pattern: Clean Arch
# Pattern #23 in the advanced OOP patterns series
...
class CleanarchImpl(CleanarchBase) {
    fun init(self) {
        super.init({"pattern":"clean_arch","version":"1.0"})
    }
    fun run(self) {
        print("Running: Clean Arch")
