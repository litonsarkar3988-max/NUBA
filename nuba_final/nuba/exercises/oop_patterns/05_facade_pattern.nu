# OOP Pattern: Facade Pattern
# Pattern #5 in the advanced OOP patterns series

class FacadepatternBase {
...
class FacadepatternImpl(FacadepatternBase) {
    fun init(self) {
        super.init({"pattern":"facade_pattern","version":"1.0"})
    }
    fun run(self) {
        print("Running: Facade Pattern")
...
let impl = new FacadepatternImpl()
