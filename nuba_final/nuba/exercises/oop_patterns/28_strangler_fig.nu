# OOP Pattern: Strangler Fig
# Pattern #28 in the advanced OOP patterns series

class StranglerfigBase {
...
class StranglerfigImpl(StranglerfigBase) {
    fun init(self) {
        super.init({"pattern":"strangler_fig","version":"1.0"})
    }
    fun run(self) {
        print("Running: Strangler Fig")
