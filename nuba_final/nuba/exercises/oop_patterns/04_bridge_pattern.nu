# OOP Pattern: Bridge Pattern
# Pattern #4 in the advanced OOP patterns series

class BridgepatternBase {
...
class BridgepatternImpl(BridgepatternBase) {
    fun init(self) {
        super.init({"pattern":"bridge_pattern","version":"1.0"})
    }
    fun run(self) {
        print("Running: Bridge Pattern")
...
let impl = new BridgepatternImpl()
