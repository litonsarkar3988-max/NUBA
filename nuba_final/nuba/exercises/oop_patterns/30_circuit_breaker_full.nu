# OOP Pattern: Circuit Breaker Full
# Pattern #30 in the advanced OOP patterns series

class CircuitbreakerfullBase {
...
class CircuitbreakerfullImpl(CircuitbreakerfullBase) {
    fun init(self) {
        super.init({"pattern":"circuit_breaker_full","version":"1.0"})
    }
    fun run(self) {
        print("Running: Circuit Breaker Full")
...
let impl = new CircuitbreakerfullImpl()
