# OOP Pattern: Cqrs Pattern
# Pattern #25 in the advanced OOP patterns series

class CqrspatternBase {
...
class CqrspatternImpl(CqrspatternBase) {
    fun init(self) {
        super.init({"pattern":"cqrs_pattern","version":"1.0"})
    }
    fun run(self) {
        print("Running: Cqrs Pattern")
