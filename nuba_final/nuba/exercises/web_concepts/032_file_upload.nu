# Web Concept: File Upload

print("=== File Upload ===")

# File Upload implementation concepts in Nuba
...
let server = new FileuploadHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to File Upload!"})
