# Web Concept: Cookie Handling

print("=== Cookie Handling ===")

# Cookie Handling implementation concepts in Nuba

class CookiehandlingHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new CookiehandlingHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Cookie Handling!"})
