# Web Concept: Nginx Concept

print("=== Nginx Concept ===")

# Nginx Concept implementation concepts in Nuba

class NginxconceptHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new NginxconceptHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Nginx Concept!"})
