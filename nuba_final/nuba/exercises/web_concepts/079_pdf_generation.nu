# Web Concept: Pdf Generation

print("=== Pdf Generation ===")

# Pdf Generation implementation concepts in Nuba
...
let server = new PdfgenerationHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Pdf Generation!"})
