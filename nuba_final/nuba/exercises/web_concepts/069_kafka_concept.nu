# Web Concept: Kafka Concept

print("=== Kafka Concept ===")

# Kafka Concept implementation concepts in Nuba

class KafkaconceptHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new KafkaconceptHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Kafka Concept!"})
