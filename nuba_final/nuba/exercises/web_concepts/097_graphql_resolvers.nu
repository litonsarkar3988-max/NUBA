# Web Concept: Graphql Resolvers

print("=== Graphql Resolvers ===")

# Graphql Resolvers implementation concepts in Nuba

class GraphqlresolversHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new GraphqlresolversHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Graphql Resolvers!"})
