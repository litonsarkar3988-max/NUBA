# Web Concept: Websocket Concept

print("=== Websocket Concept ===")

# Websocket Concept implementation concepts in Nuba

class WebsocketconceptHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new WebsocketconceptHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Websocket Concept!"})
