# Web Concept: Docker Concept

print("=== Docker Concept ===")

# Docker Concept implementation concepts in Nuba

class DockerconceptHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new DockerconceptHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Docker Concept!"})
