# Web Concept: Performance Testing

print("=== Performance Testing ===")

# Performance Testing implementation concepts in Nuba
...
let server = new PerformancetestingHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Performance Testing!"})
