# Web Concept: Nosql Concept

print("=== Nosql Concept ===")

# Nosql Concept implementation concepts in Nuba

class NosqlconceptHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new NosqlconceptHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Nosql Concept!"})
