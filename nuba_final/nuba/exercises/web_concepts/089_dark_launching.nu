# Web Concept: Dark Launching

print("=== Dark Launching ===")

# Dark Launching implementation concepts in Nuba

class DarklaunchingHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new DarklaunchingHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Dark Launching!"})
