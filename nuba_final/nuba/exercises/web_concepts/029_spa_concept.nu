# Web Concept: Spa Concept

print("=== Spa Concept ===")

# Spa Concept implementation concepts in Nuba

class SpaconceptHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new SpaconceptHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Spa Concept!"})
