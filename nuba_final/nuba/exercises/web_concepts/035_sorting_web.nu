# Web Concept: Sorting Web

print("=== Sorting Web ===")

# Sorting Web implementation concepts in Nuba

class SortingwebHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new SortingwebHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Sorting Web!"})
