# Web Concept: Feature Flags

print("=== Feature Flags ===")

# Feature Flags implementation concepts in Nuba
...
let server = new FeatureflagsHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Feature Flags!"})
