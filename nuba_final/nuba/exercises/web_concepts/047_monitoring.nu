# Web Concept: Monitoring

print("=== Monitoring ===")

# Monitoring implementation concepts in Nuba
...
let server = new MonitoringHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Monitoring!"})
