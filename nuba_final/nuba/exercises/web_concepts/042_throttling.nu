# Web Concept: Throttling

print("=== Throttling ===")

# Throttling implementation concepts in Nuba
...
let server = new ThrottlingHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Throttling!"})
