# Web Concept: Http2 Http3

print("=== Http2 Http3 ===")

# Http2 Http3 implementation concepts in Nuba

class Http2Http3Handler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new Http2Http3Handler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Http2 Http3!"})
