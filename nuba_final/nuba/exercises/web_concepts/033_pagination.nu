# Web Concept: Pagination

print("=== Pagination ===")

# Pagination implementation concepts in Nuba
...
let server = new PaginationHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Pagination!"})
