# Web Concept: Service Mesh Web

print("=== Service Mesh Web ===")

# Service Mesh Web implementation concepts in Nuba

class ServicemeshwebHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new ServicemeshwebHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Service Mesh Web!"})
