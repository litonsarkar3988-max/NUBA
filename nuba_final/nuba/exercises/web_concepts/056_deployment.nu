# Web Concept: Deployment

print("=== Deployment ===")

# Deployment implementation concepts in Nuba
...
let server = new DeploymentHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Deployment!"})
