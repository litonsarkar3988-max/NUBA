# Web Concept: Push Notifications

print("=== Push Notifications ===")

# Push Notifications implementation concepts in Nuba
...
let server = new PushnotificationsHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Push Notifications!"})
