# Web Concept: Video Processing

print("=== Video Processing ===")

# Video Processing implementation concepts in Nuba
...
let server = new VideoprocessingHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Video Processing!"})
