# Web Concept: Xss Prevention

print("=== Xss Prevention ===")

# Xss Prevention implementation concepts in Nuba

class XsspreventionHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new XsspreventionHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Xss Prevention!"})
