# Web Concept: Rabbitmq Concept

print("=== Rabbitmq Concept ===")

# Rabbitmq Concept implementation concepts in Nuba

class RabbitmqconceptHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new RabbitmqconceptHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Rabbitmq Concept!"})
