# Web Concept: Client Libraries

print("=== Client Libraries ===")

# Client Libraries implementation concepts in Nuba

class ClientlibrariesHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new ClientlibrariesHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Client Libraries!"})
