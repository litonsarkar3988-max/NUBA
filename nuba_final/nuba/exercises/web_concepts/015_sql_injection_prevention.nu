# Web Concept: Sql Injection Prevention

print("=== Sql Injection Prevention ===")

# Sql Injection Prevention implementation concepts in Nuba

class SqlinjectionpreventionHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new SqlinjectionpreventionHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Sql Injection Prevention!"})
