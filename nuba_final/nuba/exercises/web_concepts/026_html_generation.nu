# Web Concept: Html Generation

print("=== Html Generation ===")

# Html Generation implementation concepts in Nuba

class HtmlgenerationHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new HtmlgenerationHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Html Generation!"})
