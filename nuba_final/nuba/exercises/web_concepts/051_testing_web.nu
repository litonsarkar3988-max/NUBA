# Web Concept: Testing Web

print("=== Testing Web ===")

# Testing Web implementation concepts in Nuba

class TestingwebHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new TestingwebHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Testing Web!"})
