# Web Concept: Cdn Concept

print("=== Cdn Concept ===")

# Cdn Concept implementation concepts in Nuba

class CdnconceptHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new CdnconceptHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Cdn Concept!"})
