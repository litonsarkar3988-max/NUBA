# Web Concept: Elasticsearch Concept

print("=== Elasticsearch Concept ===")

# Elasticsearch Concept implementation concepts in Nuba

class ElasticsearchconceptHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new ElasticsearchconceptHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Elasticsearch Concept!"})
