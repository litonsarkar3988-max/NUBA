# Web Concept: Reverse Proxy

print("=== Reverse Proxy ===")

# Reverse Proxy implementation concepts in Nuba
...
let server = new ReverseproxyHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Reverse Proxy!"})
