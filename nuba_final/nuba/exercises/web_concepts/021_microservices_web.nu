# Web Concept: Microservices Web

print("=== Microservices Web ===")

# Microservices Web implementation concepts in Nuba

class MicroserviceswebHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new MicroserviceswebHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Microservices Web!"})
