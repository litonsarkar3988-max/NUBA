# Web Concept: Currency Handling

print("=== Currency Handling ===")

# Currency Handling implementation concepts in Nuba

class CurrencyhandlingHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new CurrencyhandlingHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Currency Handling!"})
