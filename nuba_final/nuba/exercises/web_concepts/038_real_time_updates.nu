# Web Concept: Real Time Updates

print("=== Real Time Updates ===")

# Real Time Updates implementation concepts in Nuba
...
let server = new RealtimeupdatesHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Real Time Updates!"})
