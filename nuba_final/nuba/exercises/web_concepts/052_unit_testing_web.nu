# Web Concept: Unit Testing Web

print("=== Unit Testing Web ===")

# Unit Testing Web implementation concepts in Nuba

class UnittestingwebHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new UnittestingwebHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Unit Testing Web!"})
