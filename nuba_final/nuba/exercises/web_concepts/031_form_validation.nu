# Web Concept: Form Validation

print("=== Form Validation ===")

# Form Validation implementation concepts in Nuba
...
let server = new FormvalidationHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Form Validation!"})
