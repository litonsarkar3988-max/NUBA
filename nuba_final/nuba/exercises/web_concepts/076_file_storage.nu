# Web Concept: File Storage

print("=== File Storage ===")

# File Storage implementation concepts in Nuba
...
let server = new FilestorageHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to File Storage!"})
