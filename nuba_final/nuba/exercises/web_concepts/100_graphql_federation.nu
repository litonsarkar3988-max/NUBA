# Web Concept: Graphql Federation

print("=== Graphql Federation ===")

# Graphql Federation implementation concepts in Nuba

class GraphqlfederationHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new GraphqlfederationHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Graphql Federation!"})
