# Web Concept: Database Web

print("=== Database Web ===")

# Database Web implementation concepts in Nuba
...
let server = new DatabasewebHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Database Web!"})
