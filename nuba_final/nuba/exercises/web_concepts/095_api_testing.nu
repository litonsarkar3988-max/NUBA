# Web Concept: Api Testing

print("=== Api Testing ===")

# Api Testing implementation concepts in Nuba
...
let server = new ApitestingHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Api Testing!"})
