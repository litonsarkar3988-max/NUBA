# Web Concept: Orm Concept

print("=== Orm Concept ===")

# Orm Concept implementation concepts in Nuba

class OrmconceptHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new OrmconceptHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Orm Concept!"})
