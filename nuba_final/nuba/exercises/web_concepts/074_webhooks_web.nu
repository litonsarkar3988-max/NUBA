# Web Concept: Webhooks Web

print("=== Webhooks Web ===")

# Webhooks Web implementation concepts in Nuba

class WebhookswebHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new WebhookswebHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Webhooks Web!"})
