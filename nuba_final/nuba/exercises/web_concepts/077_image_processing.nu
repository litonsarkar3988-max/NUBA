# Web Concept: Image Processing

print("=== Image Processing ===")

# Image Processing implementation concepts in Nuba
...
let server = new ImageprocessingHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Image Processing!"})
