# Web Concept: Excel Generation

print("=== Excel Generation ===")

# Excel Generation implementation concepts in Nuba

class ExcelgenerationHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new ExcelgenerationHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Excel Generation!"})
