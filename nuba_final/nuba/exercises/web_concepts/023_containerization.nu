# Web Concept: Containerization

print("=== Containerization ===")

# Containerization implementation concepts in Nuba

class ContainerizationHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new ContainerizationHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Containerization!"})
