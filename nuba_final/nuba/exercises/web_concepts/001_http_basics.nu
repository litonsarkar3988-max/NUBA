# Web Concept: Http Basics

print("=== Http Basics ===")

# Http Basics implementation concepts in Nuba

class HttpbasicsHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new HttpbasicsHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Http Basics!"})
