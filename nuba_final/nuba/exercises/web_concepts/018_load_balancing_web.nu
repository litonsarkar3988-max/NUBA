# Web Concept: Load Balancing Web

print("=== Load Balancing Web ===")

# Load Balancing Web implementation concepts in Nuba

class LoadbalancingwebHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new LoadbalancingwebHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Load Balancing Web!"})
