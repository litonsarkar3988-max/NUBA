# Web Concept: Css Generation

print("=== Css Generation ===")

# Css Generation implementation concepts in Nuba

class CssgenerationHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new CssgenerationHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Css Generation!"})
