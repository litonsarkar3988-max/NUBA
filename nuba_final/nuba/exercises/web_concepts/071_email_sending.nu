# Web Concept: Email Sending

print("=== Email Sending ===")

# Email Sending implementation concepts in Nuba
...
let server = new EmailsendingHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Email Sending!"})
