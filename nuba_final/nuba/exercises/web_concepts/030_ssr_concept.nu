# Web Concept: Ssr Concept

print("=== Ssr Concept ===")

# Ssr Concept implementation concepts in Nuba

class SsrconceptHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new SsrconceptHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Ssr Concept!"})
