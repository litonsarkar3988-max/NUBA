# Web Concept: Graphql Subscriptions

print("=== Graphql Subscriptions ===")

# Graphql Subscriptions implementation concepts in Nuba

class GraphqlsubscriptionsHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new GraphqlsubscriptionsHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Graphql Subscriptions!"})
