# Web Concept: Indexing Web

print("=== Indexing Web ===")

# Indexing Web implementation concepts in Nuba

class IndexingwebHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new IndexingwebHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Indexing Web!"})
