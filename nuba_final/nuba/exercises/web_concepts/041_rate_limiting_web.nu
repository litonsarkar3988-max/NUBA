# Web Concept: Rate Limiting Web

print("=== Rate Limiting Web ===")

# Rate Limiting Web implementation concepts in Nuba

class RatelimitingwebHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new RatelimitingwebHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Rate Limiting Web!"})
