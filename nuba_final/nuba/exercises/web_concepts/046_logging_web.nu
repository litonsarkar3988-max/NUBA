# Web Concept: Logging Web

print("=== Logging Web ===")

# Logging Web implementation concepts in Nuba

class LoggingwebHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new LoggingwebHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Logging Web!"})
