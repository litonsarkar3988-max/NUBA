# Web Concept: Dashboard Web

print("=== Dashboard Web ===")

# Dashboard Web implementation concepts in Nuba

class DashboardwebHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new DashboardwebHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Dashboard Web!"})
