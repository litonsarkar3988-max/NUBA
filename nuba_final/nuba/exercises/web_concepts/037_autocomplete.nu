# Web Concept: Autocomplete

print("=== Autocomplete ===")

# Autocomplete implementation concepts in Nuba
...
let server = new AutocompleteHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Autocomplete!"})
