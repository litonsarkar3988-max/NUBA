# Web Concept: Retry Logic Web

print("=== Retry Logic Web ===")

# Retry Logic Web implementation concepts in Nuba

class RetrylogicwebHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new RetrylogicwebHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Retry Logic Web!"})
