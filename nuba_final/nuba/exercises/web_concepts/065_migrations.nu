# Web Concept: Migrations

print("=== Migrations ===")

# Migrations implementation concepts in Nuba
...
let server = new MigrationsHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Migrations!"})
