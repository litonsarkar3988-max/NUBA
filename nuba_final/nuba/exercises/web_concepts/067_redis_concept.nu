# Web Concept: Redis Concept

print("=== Redis Concept ===")

# Redis Concept implementation concepts in Nuba

class RedisconceptHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new RedisconceptHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Redis Concept!"})
