# Web Concept: Cron Jobs Web

print("=== Cron Jobs Web ===")

# Cron Jobs Web implementation concepts in Nuba

class CronjobswebHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new CronjobswebHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Cron Jobs Web!"})
