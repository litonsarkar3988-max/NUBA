# Web Concept: Filtering Web

print("=== Filtering Web ===")

# Filtering Web implementation concepts in Nuba
...
let server = new FilteringwebHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Filtering Web!"})
