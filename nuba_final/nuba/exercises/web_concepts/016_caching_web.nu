# Web Concept: Caching Web

print("=== Caching Web ===")

# Caching Web implementation concepts in Nuba
...
let server = new CachingwebHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Caching Web!"})
