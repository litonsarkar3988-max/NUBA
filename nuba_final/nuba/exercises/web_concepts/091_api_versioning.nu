# Web Concept: Api Versioning

print("=== Api Versioning ===")

# Api Versioning implementation concepts in Nuba
...
let server = new ApiversioningHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Api Versioning!"})
