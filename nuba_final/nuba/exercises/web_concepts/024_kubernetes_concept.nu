# Web Concept: Kubernetes Concept

print("=== Kubernetes Concept ===")

# Kubernetes Concept implementation concepts in Nuba

class KubernetesconceptHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new KubernetesconceptHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Kubernetes Concept!"})
