# Web Concept: Serverless

print("=== Serverless ===")

# Serverless implementation concepts in Nuba
...
let server = new ServerlessHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Serverless!"})
