# Web Concept: Authentication

print("=== Authentication ===")

# Authentication implementation concepts in Nuba
...
let server = new AuthenticationHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Authentication!"})
