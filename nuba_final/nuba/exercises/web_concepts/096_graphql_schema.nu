# Web Concept: Graphql Schema

print("=== Graphql Schema ===")

# Graphql Schema implementation concepts in Nuba
...
let server = new GraphqlschemaHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Graphql Schema!"})
