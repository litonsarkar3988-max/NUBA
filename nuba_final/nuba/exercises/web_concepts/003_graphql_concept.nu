# Web Concept: Graphql Concept

print("=== Graphql Concept ===")

# Graphql Concept implementation concepts in Nuba

class GraphqlconceptHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new GraphqlconceptHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Graphql Concept!"})
