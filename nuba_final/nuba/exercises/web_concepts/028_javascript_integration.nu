# Web Concept: Javascript Integration

print("=== Javascript Integration ===")

# Javascript Integration implementation concepts in Nuba

class JavascriptintegrationHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new JavascriptintegrationHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Javascript Integration!"})
