# Web Concept: Search Web

print("=== Search Web ===")

# Search Web implementation concepts in Nuba
...
let server = new SearchwebHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Search Web!"})
