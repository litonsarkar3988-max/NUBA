# Web Concept: Csrf Protection

print("=== Csrf Protection ===")

# Csrf Protection implementation concepts in Nuba
...
let server = new CsrfprotectionHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Csrf Protection!"})
