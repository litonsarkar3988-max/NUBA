# Web Concept: Sms Sending

print("=== Sms Sending ===")

# Sms Sending implementation concepts in Nuba

class SmssendingHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new SmssendingHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Sms Sending!"})
