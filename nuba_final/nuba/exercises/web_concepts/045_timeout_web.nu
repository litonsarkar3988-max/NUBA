# Web Concept: Timeout Web

print("=== Timeout Web ===")

# Timeout Web implementation concepts in Nuba

class TimeoutwebHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new TimeoutwebHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Timeout Web!"})
