# Web Concept: Oauth Concept

print("=== Oauth Concept ===")

# Oauth Concept implementation concepts in Nuba

class OauthconceptHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new OauthconceptHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Oauth Concept!"})
