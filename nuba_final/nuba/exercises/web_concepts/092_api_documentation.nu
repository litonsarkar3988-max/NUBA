# Web Concept: Api Documentation

print("=== Api Documentation ===")

# Api Documentation implementation concepts in Nuba
...
let server = new ApidocumentationHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Api Documentation!"})
