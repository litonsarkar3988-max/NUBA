# Web Concept: Sdk Generation

print("=== Sdk Generation ===")

# Sdk Generation implementation concepts in Nuba

class SdkgenerationHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new SdkgenerationHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Sdk Generation!"})
