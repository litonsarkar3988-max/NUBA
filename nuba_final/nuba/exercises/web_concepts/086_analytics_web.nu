# Web Concept: Analytics Web

print("=== Analytics Web ===")

# Analytics Web implementation concepts in Nuba
...
let server = new AnalyticswebHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Analytics Web!"})
