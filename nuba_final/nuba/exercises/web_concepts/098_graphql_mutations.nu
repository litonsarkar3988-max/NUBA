# Web Concept: Graphql Mutations

print("=== Graphql Mutations ===")

# Graphql Mutations implementation concepts in Nuba

class GraphqlmutationsHandler {
    fun init(self) {
        self.config  = {}
        self.routes  = []
        self.middleware = []
...
let server = new GraphqlmutationsHandler()
...
server.add_route("GET",  "/", fun(ctx) -> {"message":"Welcome to Graphql Mutations!"})
