# Physics Exercise 14: Light Reflection
# Physics: Light Reflection

print("=== Light Reflection ===")

fun calculate_light_reflection(params) {
    print("Calculating: Light Reflection")
...
let results = calculate_light_reflection(inputs)
print("Results:")
